 ...
 */
package com.find.any.boot.config;
...
import com.find.any.boot.props.MybatisPlusProperties;
import com.find.any.mybatis.plugins.SqlLogInterceptor;
...
@AllArgsConstructor
@MapperScan("com.find.any.**.mapper.**")
@EnableConfigurationProperties(com.find.any.boot.props.MybatisPlusProperties.class)
