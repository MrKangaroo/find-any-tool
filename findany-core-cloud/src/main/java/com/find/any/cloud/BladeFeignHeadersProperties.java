...
@Setter
@RefreshScope
@org.springframework.boot.context.properties.ConfigurationProperties("blade.feign.headers")
public class BladeFeignHeadersProperties {
	 ...
	 */
	private java.util.List<String> allowed = Arrays.asList("X-Real-IP", "x-forwarded-for", "authorization", "blade-auth", "Authorization", "Blade-Auth");
