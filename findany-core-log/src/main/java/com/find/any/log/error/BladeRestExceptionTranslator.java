 ...
 */
package com.find.any.log.error;

import com.find.any.core.tool.api.R;
import com.find.any.core.tool.api.ResultCode;
import com.find.any.core.tool.utils.Func;
import com.find.any.core.tool.utils.UrlUtil;
import com.find.any.core.tool.utils.WebUtil;
import com.find.any.log.publisher.ErrorLogPublisher;
import lombok.extern.slf4j.Slf4j;
import org.hibernate.validator.internal.engine.path.PathImpl;
import com.find.any.log.exception.ServiceException;
import com.find.any.log.publisher.ErrorLogPublisher;
...
public class BladeRestExceptionTranslator {
	...
	public R handleError(Throwable e) {
		...
		return R.fail(ResultCode.INTERNAL_SERVER_ERROR, (Func.isEmpty(e.getMessage()) ? ResultCode.INTERNAL_SERVER_ERROR.getMsg() : e.getMessage()));
	}
