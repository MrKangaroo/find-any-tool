...
public class BladeRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
	...
	@Override
	protected void handlerMethodsInitialized(java.util.Map<RequestMappingInfo, HandlerMethod> handlerMethods) {
		// 打印路由信息 spring boot 2.1 去掉了这个 日志的打印
		if (logger.isInfoEnabled()) {
			for (java.util.Map.Entry<RequestMappingInfo, HandlerMethod> entry : handlerMethods.entrySet()) {
