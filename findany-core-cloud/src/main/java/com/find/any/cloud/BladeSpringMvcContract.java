...
import com.find.any.cloud.annotation.ApiVersion;
import com.find.any.cloud.annotation.UrlVersion;
import com.find.any.core.tool.utils.StringPool;
 ...
 *
 * @see com.find.any.cloud.annotation.UrlVersion
 * @see com.find.any.cloud.annotation.ApiVersion
 * @author L.cm
 */
public class BladeSpringMvcContract extends SpringMvcContract {

	public BladeSpringMvcContract(java.util.List<AnnotatedParameterProcessor> annotatedParameterProcessors, ConversionService conversionService) {
