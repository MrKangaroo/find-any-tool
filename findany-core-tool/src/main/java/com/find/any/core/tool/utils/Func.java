 ...
 */
package com.find.any.core.tool.utils;
...
public class Func {
	...
	public static byte[] toJsonAsBytes(Object object) {
		return JacksonUtil.toJsonAsBytes(object);
	}
	...
	public static JsonNode readTree(String jsonString) {
		return JacksonUtil.readTree(jsonString);
	}
	...
	public static JsonNode readTree(InputStream in) {
		return JacksonUtil.readTree(in);
	}
	...
	public static <T> T parse(byte[] bytes, Class<T> valueType) {
		return JacksonUtil.parse(bytes, valueType);
	}
	...
	public static <T> T parse(String jsonString, Class<T> valueType) {
		return JacksonUtil.parse(jsonString, valueType);
	}
	...
	public static <T> T parse(InputStream in, Class<T> valueType) {
		return JacksonUtil.parse(in, valueType);
	}
	...
	public static <T> T parse(byte[] bytes, TypeReference<T> typeReference) {
		return JacksonUtil.parse(bytes, typeReference);
	}
	...
	public static <T> T parse(InputStream in, TypeReference<T> typeReference) {
		return JacksonUtil.parse(in, typeReference);
	}
