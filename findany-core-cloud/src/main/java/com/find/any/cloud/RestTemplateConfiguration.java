...
import com.find.any.core.tool.utils.Charsets;
...
public class RestTemplateConfiguration {
	 ...
	 */
	@org.springframework.context.annotation.Bean("httpLoggingInterceptor")
	@Profile({"dev", "test"})
	...
	public okhttp3.OkHttpClient httpClient(
		org.springframework.cloud.commons.httpclient.OkHttpClientFactory httpClientFactory,
	...
	public org.springframework.web.client.RestTemplate restTemplate(okhttp3.OkHttpClient httpClient) {
		org.springframework.web.client.RestTemplate restTemplate = new RestTemplate(new OkHttp3ClientHttpRequestFactory(httpClient));
	...
	private void configMessageConverters(java.util.List<org.springframework.http.converter.HttpMessageConverter<?>> converters) {
